...
if __name__ == "__main__":
    ...
    run_fast_minimizer()          # Minimize Docker/XServer early
    clean_old_builds()
    kill_running_exe()
    freeze_requirements()
    run_pyinstaller()
    build_docker_image()
    run_fast_minimizer()          # Minimize again post-build